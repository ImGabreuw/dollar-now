...
public class DollarDbHelper extends SQLiteOpenHelper {
    ...
    public DollarDbHelper(Context context) {
    ...
    @SuppressLint("NewApi")
    public List<Dollar> getAllDollarQuotations() {
        SQLiteDatabase db = getReadableDatabase();
        List<Dollar> quotations = new ArrayList<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                Dollar quotation = new Dollar(date, price, variation);
    ...
    public void insertOrUpdateDollarQuotation(Dollar quotation) {
